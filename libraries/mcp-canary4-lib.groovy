library(name: "McpCanary4Lib", namespace: "mcp", author: "kingpanther13", description: "Canary4: a marker probe plus the FULL dashboards lib body pasted verbatim and unwired, to test whether the dashboards CONTENT breaks the hub library parse while the marker stops binding. Diagnostic only.")

String mcpCanary4Marker() { return "canary4-ok-v1" }
