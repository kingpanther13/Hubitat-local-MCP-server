...
6. **Schema design** — `enum` for fixed-set free-text params; `required` only when applicable; do not add `outputSchema` declarations or `structuredContent` emission (removed — AGENTS.md § Schema design).
