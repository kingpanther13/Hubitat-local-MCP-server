...
class HandleToolsCallReactiveBpsSpec extends ToolSpecBase {
    ...
    def "a returned success:false error gets a bp_warning pointing at the tool's section"() {
        given:
        script.metaClass.toolSendCommand = { d, c, p = null, w = null, cmds = null, t0 = null -> [success: false, error: "Device not found: 42"] }
    ...
    def "a successful result is never scanned (no bp_warning)"() {
        given:
        script.metaClass.toolSendCommand = { d, c, p = null, w = null, cmds = null, t0 = null -> [success: true] }
    ...
    def "a pre-existing bp_warning is not overwritten (idempotent)"() {
        given:
        script.metaClass.toolSendCommand = { d, c, p = null, w = null, cmds = null, t0 = null -> [success: false, error: "x", bp_warning: "PRESET"] }
    ...
    def "a thrown IAE with a null message does not crash and is not augmented"() {
        given:
        script.metaClass.toolSendCommand = { d, c, p = null, w = null, cmds = null, t0 = null -> throw new IllegalArgumentException() }
    ...
    def "a hint-attach failure (immutable result Map) does NOT mask the original error"() {
        given:
        script.metaClass.toolSendCommand = { d, c, p = null, w = null, cmds = null, t0 = null -> [success: false, error: "Device not found: 7"].asImmutable() }
