...
| `hub_manage_devices` | 11 | Device command/swap/replace/create/update (writes, incl. Hub Mesh device link/unlink and variable share) + list/get devices, attributes, events, Hub Mesh (reads) |
