...
- **enabled** — POSTs JSON to `/device/disable` with numeric `id` and boolean `disable` (undocumented API, `Content-Type: application/json`; requires the Write master and fresh readback)
