...
| `hub_search_tools` | BM25 natural language search across all 98 tools — returns matching tools ranked by relevance, with gateway attribution so the AI knows how to call each. | None |
