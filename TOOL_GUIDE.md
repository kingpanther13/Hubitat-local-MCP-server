...
As of v0.8.0, the server uses **domain-named gateways** to organize 51 lesser-used tools behind 10 gateway tools. The MCP `tools/list` shows 31 items (21 core + 10 gateways) instead of 72.
