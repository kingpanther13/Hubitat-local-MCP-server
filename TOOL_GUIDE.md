...
- Write verbs (`hub_update_custom_rule`): points to `hub_get_app_config` for inspection and `hub_manage_rule_machine -> hub_set_rule` for programmatic modification (requires Built-in App Tools + Hub Admin Write).
